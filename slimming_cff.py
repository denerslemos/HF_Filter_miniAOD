...
pp_on_AA_2018.toReplaceWith(slimmingTask, cms.Task(slimmingTask.copy(), hihffilter, packedPFCandidateMuonID, lostTrackMuonID, packedPFCandidateTrackChi2 , lostTrackChi2, hipixeltracks))
